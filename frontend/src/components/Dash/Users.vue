...
export default {
  ...
  methods: {
    ...
    async changeUserRole(role, userID) {
      let confirmRole = true;
      // TODO: Add custom popup instead of confirm
      // Will need to add async option to popups.
      if (role === 'owner') confirmRole = window.confirm('Promoting this user to owner will demote you to an admin, are you sure you want to continue?');
      if (confirmRole) console.log(this.users);
